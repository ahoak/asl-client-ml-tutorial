import{J as x,A as E,k as y,a as f,m as B,n as s,o as g,p as H,t as u,e as p,V as v,q as T,r as D,u as k,s as j}from"./utils.9dae1f18.js";import"./WebcamSelector.656f3587.js";const P="ASL Fingerspelling Model Tutorial",q="Train ASL Fingerspelling ML Model using Tensorflowjs",U="ASL Fingerspelling Tutorial \u{1F44B}",J="",W="images/ghc_logo_v4.svg",Y="Grace Hopper Celebration",Z={github:"https://github.com/ahoak/asl-client-ml-tutorial",twitter:"https://twitter.com/amber_hoak"},X=!1,Q=[{step:1,description:"Load Data",helperText:"Load preprocessed data by pressing the button",name:"loadData",readOnly:"true",imageLink:"instructions/loadData.png"},{step:2,description:"Create and Configure Model",helperText:"creating a feed-forward model. We will use 5 layers with relu activation function. Function must return the model.",name:"createModel",readOnly:"false",imageLink:"instructions/createModel.png"},{step:3,description:"Train Model",helperText:"edit function trainModel() by using the Tf.fit API. Set the following parameters: epochs, batchSize,validationData, callbacks. Hint, you may need to transform your data into tensors ",name:"trainModel",readOnly:"false",imageLink:"instructions/trainModel.png"},{step:4,description:"Download Model Files",helperText:"Click the button to download your shiney new model. We will use this in our webapp.",name:"exportModel",readOnly:"true",imageLink:"instructions/exportModel.png"}],G=[{step:1,description:"Import Model",helperText:"Import a pre-trained model to perform inference with."},{step:2,description:"Extract and Process Joint Positions",helperText:"Extract the hand joint positions from within an image."},{step:3,description:"Classify",helperText:"Run inference with the normalized joint positions to get a classification (ASL sign)."},{step:4,description:"Run",helperText:"Run prediction on the model"}],K={metaTitle:P,metaDescription:q,name:U,theme:J,avatarImage:W,avatarImageAlt:Y,social:Z,showDataVideo:X,trainTutorialSteps:Q,predictSteps:G};function z(o){const t=[],e=[],n=f.reduce((i,r,a)=>(i[r]=Array.from({length:f.length}).fill(0),i[r][a]=1,i),{});return Object.keys(o).forEach(i=>{const r=o[i],a=n[i];r.forEach(d=>{t.push(d),e.push(a)})}),{inputs:t,outputs:e}}function L(o,t){const[e,,n]=B(o,t,{testSize:.1,randomState:42}),[i,r,a,d]=B(e,n,{testSize:.1,randomState:42});return[i,r,a,d]}function A(o,t){const e=document.createElement("a");e.setAttribute("href","data:application/zip;base64,"+t),e.setAttribute("download",o),e.style.display="none",document.body.appendChild(e),e.click(),document.body.removeChild(e)}async function tt(o){await o.save("localstorage://model"),console.log("model saved to localstorage!");const t=new x,n=await o.save(new E);Object.keys(n.data).forEach((i,r)=>{r===0?t.file(i,JSON.stringify(n.data[i])):t.file(i,n.data[i])}),await t.generateAsync({type:"base64"}).then(function(i){A("model.zip",i)},function(i){console.warn(i)})}async function et(o,t,e,n,i=5,r=128){if(!o||!t||!e)return new Error("missing parameter for trainModel");const a=y(t.inputs),d=y(t.outputs),c=y(e.inputs),l=y(e.outputs),h=await o.fit(a,d,{epochs:i,batchSize:r,verbose:1,validationData:[c,l],callbacks:n});return a.dispose(),d.dispose(),c.dispose(),l.dispose(),h}const nt=".loading-element",$=".train-button",V="#validation-status";function m(o,t,e){const n=s(V);n.innerHTML=e;const i=s(nt);if(i.style.visibility="hidden",M(o,t),t){const r=s($);r.disabled=!1}}function it(o){M(o,null),_()}function _(){const o=s(V);o.innerHTML="";const t=s($);t.disabled=!0}const ot=new Map([["loadData","\u2714\uFE0F Data loaded \u{1F4BE}"],["createModel","\u2714\uFE0F Yay! Model created! \u{1F389}"],["trainModel","\u2714\uFE0F Training complete!\u{1F45F}"],["exportModel",'\u2714\uFE0F Downloaded! Time to make some <a href="/asl-client-ml-tutorial/predict#step1">predictions</a> \u{1F57A}']]);function b(o){return ot.get(o)??""}function M(o,t){const e=s(`#tutorial-step${o}`);e?.classList.toggle("valid",t!=null&&t),e?.classList.toggle("invalid",t!=null&&!t)}class st{#n=g;#o=128;#i=1;#t=0;#s;#d=!0;#r=s(".training-feedback-container");#u=s(".training-progress-bar");#a=s(".training-start-button");#e=s(".training-stop-button");#l={};#c;#p;constructor(t){this.#n=t?.epochs??g}set aslModel(t){this.#p=t}get aslModel(){return this.#p}set currentStep(t){this.#s=t}get currentStep(){return this.#s}get step(){return this.#s?.step}get stepName(){return this.#s?.name}get epochs(){return this.#n}completedValidation(t,e){this.#l[t]=e}getCompletedState(t){return this.#l[t]??!1}handleReset(t){t==="createModel"&&(this.#p=void 0),this.completedValidation(t,!1)}getTrainingData(){if(this.#c){const[t,,e]=this.#c;return{inputs:t,outputs:e}}}getValidationData(){if(this.#c){const[,t,,e]=this.#c;return{inputs:t,outputs:e}}}handleModelResults=t=>{t.valid&&t.data&&t.data.length>0&&(this.#p=t.data[0])};handleModelCreation=t=>{t.valid&&t.data&&t.data.length>0?this.#p=t.data[0]:console.log("no data provided to ModelBuilder, please retry load data function")};handleDataSplitValidation=t=>{t.valid&&t.data&&t.data.length>0?this.#c=t.data[0]:console.log("no data provided to ModelBuilder, please retry load data function")};handleTrainValidation=t=>{if(t.valid&&t.data&&t.data.length>0){const[e,n]=t.data;this.#o=e,this.#n=n}else console.log("no data provided to ModelBuilder, please retry load data function")};onBatchEnd=(t,e)=>{this.#r.style.display="inline-block",!this.#d&&this.#p&&(this.#p.stopTraining=!0),this.#r.innerHTML=`
      ...
      <br>
      `};async onDownload(){const t=this.#p;t?(await tt(t),m(this.step??1,!0,b("exportModel"))):m(this.step??1,!1,"no model loaded")}onEpochEnd=t=>{const e=Date.now()-this.#t;this.#i=t+2;const n=this.#n-t,i=e*n,[r,a]=H(i);this.#u.innerHTML=`${r} ${a?"minutes":"seconds"} remaining`,this.#t=Date.now(),t===this.#n-1&&m(this.step??1,!0,b("trainModel"))};getCallbacks(){return{onBatchEnd:this.onBatchEnd,onEpochEnd:this.onEpochEnd}}handleValidationComplete=(t,e,n)=>{if(this.#s?.step===e){const i=n?b(t):"validation failed";n&&t==="trainModel"?this.enableTrainingButtons():this.disableTrainingButtons(),t==="trainModel"?M(e,n):t!=="exportModel"&&m(e,n,i)}};disableTrainingButtons(){this.#a.disabled=!0,this.#e.disabled=!0}enableTrainingButtons(){this.#a.disabled=!1,this.#e.disabled=!1}handleTrainingStopped(){this.#d=!1,this.#a.disabled=!1,m(this.step??1,!0,b("trainModel"))}getTrainingInputs(){return[this.#p,this.getTrainingData(),this.getValidationData(),this.getCallbacks(),this.#n]}async onTrainingClick(){const[t,e,n,i,r]=this.getTrainingInputs();t&&(t.stopTraining=!1,this.#d=!0,this.#i=1,this.#a.disabled=!0,await et(t,e,n,i,r,this.#o))}set trainingEnabled(t){this.#d=t}}const at=`
...
`;function mt(o,t,e,n){return new Function("model","ArrayBufferModelSaver","download","tf","tfjs","JSZip",`return (${o.replace(/export/g,"")})`)(t,e,n,u,u,x,E)}async function ft(o,t){try{await o(t,new E,A)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:v.Unknown,detail:n}]}}return{valid:!0,errors:[]}}const gt=Object.freeze(Object.defineProperty({__proto__:null,template:pt,solution:ht,implementation:mt,validate:ft},Symbol.toStringTag,{value:"Module"})),yt=`
// READ-ONLY
...
`;function wt(o){return new Function("loadAsync","jszip","jsZipInstance","tf","tfjs","assetURL","applyOneHotEncoding","splitTrainingData",`return (${o.replace(/export/g,"")})`)(T,D,D,u,u,k,z,L)}async function vt(o){let t;try{if(t=await o(T,k,z,L),!t||t.length<4)return p(`
          data did not load
      `)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:v.Unknown,detail:n}]}}return{valid:!0,errors:[],data:[t]}}const St=Object.freeze(Object.defineProperty({__proto__:null,template:yt,solution:bt,implementation:wt,validate:vt},Symbol.toStringTag,{value:"Module"})),Et=`
