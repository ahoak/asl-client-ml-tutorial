...
function createModel(classes: string[]):LayersModel {
  ...
  return model;
}`;function U(i){return new Function("classes","tf","tfjs",`return (${i.replace(/export/g,"")})`)(h,u,u)}async function q(i){let t;try{if(t=await i(h),!t)return m(`"We couldn't find your model. Did you implement createModel function? If so, check that you return your model`)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:f.Unknown,detail:n}]}}return{valid:!0,errors:[],data:[t]}}const X=Object.freeze(Object.defineProperty({__proto__:null,template:N,solution:P,solve:Y,implementation:U,validate:q},Symbol.toStringTag,{value:"Module"}));function k(i){const t=[],e=[],n=h.reduce((a,o,r)=>(a[o]=Array.from({length:h.length}).fill(0),a[o][r]=1,a),{});return Object.keys(i).forEach(a=>{const o=i[a],r=n[a];o.forEach(l=>{t.push(l),e.push(r)})}),{X:t,Y:e}}function M(i,t){const[e,,n]=w(i,t,{testSize:.1,randomState:42}),[a,o,r,l]=w(e,n,{testSize:.1,randomState:42});return[a,o,r,l]}function J(i,t){const e=document.createElement("a");e.setAttribute("href","data:application/zip;base64,"+t),e.setAttribute("download",i),e.style.display="none",document.body.appendChild(e),e.click(),document.body.removeChild(e)}const W=`
// READ-ONLY
...
`;function Q(i,t,e,n){return new Function("model","ArrayBufferModelSaver","download","tf","tfjs","JSZip",`return (${i.replace(/export/g,"")})`)(t,e,n,u,u,L,x)}async function G(i,t){try{await i(t,new x,J)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:f.Unknown,detail:n}]}}return{valid:!0,errors:[]}}const K=Object.freeze(Object.defineProperty({__proto__:null,template:W,solution:Z,implementation:Q,validate:G},Symbol.toStringTag,{value:"Module"})),tt=`
// READ-ONLY
...
`;function nt(i){return new Function("loadAsync","jszip","jsZipInstance","tf","tfjs","assetURL","applyOneHotEncoding","splitTrainingData",`return (${i.replace(/export/g,"")})`)(g,T,T,u,u,b,k,M)}async function at(i){let t;try{if(t=await i(g,b,k,M),!t||t.length<4)return m(`
          data did not load
      `)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:f.Unknown,detail:n}]}}return{valid:!0,errors:[],data:[t]}}const it=Object.freeze(Object.defineProperty({__proto__:null,template:tt,solution:et,implementation:nt,validate:at},Symbol.toStringTag,{value:"Module"})),ot=`
...
`;function lt(i,t,e,n,a,o,r,l){return new Function("model","xTrainData","yTrainData","xValidationData","yValidationData","callbacks","numEpochs","tf","tfjs",`return (${i.replace(/export/g,"")})`)(t,e,n,a,o,r,l,u,u)}async function dt(i,t,e,n,a,o,r,l){try{const d=await i(t,e,n,a,o,r,l);if(d){if(!d.params)return m(`
      ...
      `)}catch(d){const c=`${d}`;return{valid:!1,errors:[{type:f.Unknown,detail:c}]}}return{valid:!0,errors:[],data:[]}}const ct=Object.freeze(Object.defineProperty({__proto__:null,template:ot,solution:st,solve:rt,implementation:lt,validate:dt},Symbol.toStringTag,{value:"Module"})),y={createModel:X,exportModel:K,trainModel:ct,loadData:it};let ut=()=>({events:{},emit(i,...t){let e=this.events[i]||[];for(let n=0,a=e.length;n<a;n++)e[n](...t)},on(i,t){return this.events[i]?.push(t)||(this.events[i]=[t]),()=>{this.events[i]=this.events[i]?.filter(e=>t!==e)}}});const p="validated",ht="validationInProgress",pt="validationComplete";class mt{#o=0;#e;#n;#a;#l=!1;#t=[];#s;#c;#r;#h;constructor(t){this.#o=t.stepCount??0,this.#e=t.stepRecord,this.#n=t.element,this.#a=t.name,this.#c=localStorage.getItem(`build-ts:${this.#a}`),this.#r=t.solutionElement,this.#s=ut(),this.setEventListener()}set show(t){t?(this.#n.setAttribute("style","display: flex;width: 100%;height:calc(100vw / 2)"),this.showSolution(!0)):(this.#n.setAttribute("style","display:none;"),this.showSolution(!1))}showSolution(t){this.#r&&(t?this.#r.setAttribute("style","display: flex;width: 100%;height:calc(100vw / 2)"):this.#r.setAttribute("style","display:none;"))}set code(t){this.#n.setAttribute("code",t)}set allowBackgroundExecution(t){this.#n.toggleAttribute("allow-background-execution",t)}set readonly(t){this.#n.toggleAttribute("readonly",t)}get solutionElement(){return this.#r}resetCodeToDefault(){this.code=this.#e.template,localStorage.removeItem(`build:${this.#a}`),localStorage.removeItem(`build-ts:${this.#a}`),this.#c=null,this.#l=!1}solve(){this.code=this.#e.solve??this.#e.solution}on(t,e){return this.#s.on(t,e)}set overrideEventListener(t){this.#h=t}setEventListener(){this.#n.addEventListener("change",async t=>{const e=t,n=!e.detail.hasSyntaxErrors,a=e.detail.transpiledCode;n&&(localStorage.setItem(`build-ts:${this.#a}`,e.detail.transpiledCode),localStorage.setItem(`build:${this.#a}`,e.detail.code),this.#c=e.detail.transpiledCode,this.#h||await this.handleEvalInput(a))})}set funcInput(t){this.#t=t}setCodeFromCacheOrDefault(){const t=localStorage.getItem(`build:${this.#a}`),e=t&&t.length>0?t:this.#e.template;this.code=e}async runCachedCode(){try{this.#c&&await this.handleEvalInput(this.#c)}catch(t){console.warn(t)}}async handleEvalInput(t){this.#s.emit(ht,this.#a,this.#o);const e=t??this.#n.getAttribute("code")??"",n=this.#e.implementation(e,...this.#t);if(this.#e.validate)try{const a=await this.#e.validate(n,...this.#t);this.#n.setAttribute("validation-issues",JSON.stringify(a.valid?[]:a.errors)),this.#l=a.valid,this.#l&&this.#s.emit(p,a)}catch(a){console.log(a)}this.#s.emit(pt,this.#a,this.#o,this.#l)}get isValid(){return this.#l}}const D=".loading-element",I=".train-button",ft=".output-container",v="#validation-status";function yt(){const i=s(ft);i.style.visibility="visible";const t=s(v);t.innerHTML="Validating solution...";const e=s(D);e.style.visibility="visible"}function E(i,t,e){const n=s(v);n.innerHTML=e;const a=s(D);if(a.style.visibility="hidden",t){const o=s(`#tutorial-step${i}`),r=C.trainTutorialSteps.find(d=>d.step===i);r&&o&&(o.innerHTML=`\u2705${r.description}`);const l=s(I);l.disabled=!1}}function gt(){const i=s(v);i.innerHTML="";const t=s(I);t.disabled=!0}const bt=new Map([["loadData","\u2714\uFE0F Data loaded \u{1F4BE}"],["createModel","\u2714\uFE0F Yay! Model created! \u{1F389}"],["trainModel","\u2714\uFE0F Training complete!\u{1F45F}"],["exportModel",'\u2714\uFE0F Downloaded! Time to make some <a href="/predict#step1">predictions</a> \u{1F57A}']]);function vt(i){return bt.get(i)??""}const wt=C,S=5;class Tt{#o=S;#e=1;#n=405*2;#a=0;#l=!1;#t;#s=!1;#c=s("#output-element");#r=s(".training-feedback-container");#h=s(".training-progress-bar");#w=document.querySelectorAll("code-step");#x=s(".training-progress-bar");#T=s(".load-data-description");#E=s("#solution-tab");#p=s(".train-button");#f=s(".reset-button");#m=s(".training-stop-button");#u=s(".training-start-button");#S=s(".download-button");#y=s(".solve-button");#g=!0;#b=!1;#v;#i;#d={};#C={};constructor(t){this.#o=t?.epochs??S}async init(){this.#p.disabled=!0,this.#p.onclick=this.handleNextButtonClick,this.#f.onclick=this.handleResetButtonClick,this.#m.onclick=this.handleStopTrainingClick,this.#u.onclick=this.handlestartTrainingClick,this.#S.onclick=this.handleDownloadClick,this.#y.onclick=this.handleSolveClick,this.mapCodeSteps(),await this.setCurrentStep(1)}mapCodeSteps(){const t=Object.keys(y).reduce((e,n)=>(e[n]={valid:!1,...y[n]},e),{});this.initCodeSteps(t)}initCodeSteps(t){const e={};this.#w.forEach(n=>{const a=n.getAttribute("name")??"";if(/-solution/.test(a)){const r=a.replace("-solution","");e[r]=n}}),this.#w.forEach(n=>{const a=n.getAttribute("name")??"",o=n.getAttribute("step")??"",r=y[a];if(a&&r){const l=t[a];let d;e[a]&&(d=e[a],d.setAttribute("code",l.solution),d.toggleAttribute("readonly",!0));const c=new mt({stepRecord:l,element:n,name:a,stepCount:+o,solutionElement:d});switch(this.#d[a]=c,this.#C[o]=a,a){case"loadData":c.funcInput=[g,b],c.on(p,this.handleDataSplitValidation),c.setCodeFromCacheOrDefault();break;case"createModel":c.funcInput=[u,h],c.on(p,this.handleModelCreation);break;case"configureModel":c.on(p,this.handleConfigureModel);break}c.on("validationComplete",this.handleValidationComplete)}})}handleValidationStarted=(t,e)=>{this.#t?.step===e&&(yt(),t==="trainModel"&&(this.#m.style.display="inline-flex"))};handleValidationComplete=(t,e,n)=>{if(this.#t?.step===e){let a="validation failed";n&&(a=vt(t)),t==="trainModel"&&this.#b,E(e,n,a)}};handleResetButtonClick=()=>{const t=this.#t?.name??"";this.#d[t].resetCodeToDefault()};handleSolveClick=()=>{const t=this.#t?.name??"",e=this.#d[t];e&&e.solve()};handleStopTrainingClick=()=>{this.#g=!1,this.#u.disabled=!1};onBatchEnd=(t,e)=>{this.#l||(this.#l=!0,this.#r.style.display="inline-block"),!this.#g&&this.#i&&(this.#i.stopTraining=!0);const n=this.#e*this.#n+(t+1),a=this.#o*this.#n,o=n/a*100;this.#x.value=o,this.#r.innerHTML=`
      ...
      <br>
      `};onEpochEnd=t=>{const e=Date.now()-this.#a;this.#e=t+2;const n=this.#o-t,a=e*n,[o,r]=V(a);this.#h.innerHTML=`${o} ${r?"minutes":"seconds"} remaining`,this.#a=Date.now(),t===this.#o-1&&(this.#b=!0)};handleConfigureModel=t=>{t.valid&&t.data&&t.data.length>0&&(this.#i=t.data[0])};handleModelCreation=t=>{t.valid&&t.data&&t.data.length>0?this.#i=t.data[0]:console.log("no data provided to ModelBuilder, please retry load data function")};handleDataSplitValidation=t=>{t.valid&&t.data&&t.data.length>0?this.#v=t.data[0]:console.log("no data provided to ModelBuilder, please retry load data function")};handleNextButtonClick=async()=>{const t=this.#t?.step??1;await this.onStepChange(t+1)};async onStepChange(t){if(this.#t){const e=this.#t.name;this.#s&&this.toggleSolution(!1,e);const n=s(`#${e}-image`);n.style.display="none";const a=this.#d[e];a.show=!1}gt(),t!==void 0&&await this.setCurrentStep(t)}handleSolutionButtonClick=()=>{const t=!this.#s,e=this.#t?.name??"";this.toggleSolution(t,e)};toggleSolution(t,e){this.#s=t,this.#d[e].showSolution(t)}handlestartTrainingClick=async()=>{const t=this.#d.trainModel;this.#i&&t&&(this.#i.stopTraining=!1,this.#g=!0,this.#e=1,this.#u.disabled=!0,this.#b=!1,this.#p.disabled=!0,await t.runCachedCode())};handleDownloadClick=async()=>{const t=this.#d.exportModel;this.#i&&t&&await t.runCachedCode()};async handleStepChange(t,e="false"){const n=this.#d[t];if(n){const a=s(`#${t}-image`);if(a.style.display="flex",n.setCodeFromCacheOrDefault(),e&&(n.readonly=e==="true"),t==="loadData"?(this.#T.style.display="block",await n.runCachedCode()):this.#T.style.display="none",t==="exportModel"&&this.#i&&(n.funcInput=[this.#i,u]),t==="trainModel"&&this.#i&&this.#v){const[o,r,l,d]=this.#v;n.funcInput=[this.#i,o,l,r,d,{onBatchEnd:this.onBatchEnd,onEpochEnd:this.onEpochEnd},this.#o],n.overrideEventListener=!0,this.#u.style.display="inline-flex",this.#m.style.display="inline-flex"}else this.#m.style.display="none",this.#u.style.display="none",this.#r.style.display="none";t==="exportModel"&&(n.overrideEventListener=!0,this.#S.style.display="inline-flex",this.#p.style.display="none"),e==="true"?(this.#f.style.display="none",this.#y.style.display="none",this.#E.style.display="none"):(this.#f.style.display="inline-flex",this.#y.style.display="inline-flex",this.#E.style.display="inline-flex"),n.show=!0}else console.error(`Instance of StepViewer for ${t} is not found`)}async setCurrentStep(t){const e=wt.trainTutorialSteps.find(n=>n.step===t);e!=null&&(this.#t=e,Et(this.#t.step),St(this.#t.step-1),this.#c.innerHTML=`${this.#t.step}. ${this.#t.description} `,await this.handleStepChange(this.#t.name,this.#t.readOnly))}}function Et(i){const t=document.querySelector(`#tutorial-step${i}`);t&&(t.style.fontWeight="bold")}function St(i){const t=document.querySelector(`#tutorial-step${i}`);t&&(t.style.fontWeight="revert")}z("build");const xt=new Tt;xt.init();
