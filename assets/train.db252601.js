...
`;function Q(i,t,e,n){return new Function("model","ArrayBufferModelSaver","download","tf","tfjs","JSZip",`return (${i.replace(/export/g,"")})`)(t,e,n,u,u,V,x)}async function G(i,t){try{await i(t,new x,J)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:m.Unknown,detail:n}]}}return{valid:!0,errors:[]}}const K=Object.freeze(Object.defineProperty({__proto__:null,template:W,solution:Z,implementation:Q,validate:G},Symbol.toStringTag,{value:"Module"})),tt=`
// READ-ONLY
...
`;function nt(i){return new Function("loadAsync","jszip","jsZipInstance","tf","tfjs","assetURL","applyOneHotEncoding","splitTrainingData",`return (${i.replace(/export/g,"")})`)(g,T,T,u,u,b,k,C)}async function at(i){let t;try{if(t=await i(g,b,k,C),!t||t.length<4)return f(`
          data did not load
