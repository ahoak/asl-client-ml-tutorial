...
`;function mt(i,t,e,n){return new Function("model","ArrayBufferModelSaver","download","tf","tfjs","JSZip",`return (${i.replace(/export/g,"")})`)(t,e,n,c,c,x,S)}async function ft(i,t){try{await i(t,new S,A)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:w.Unknown,detail:n}]}}return{valid:!0,errors:[]}}const gt=Object.freeze(Object.defineProperty({__proto__:null,template:pt,solution:ht,implementation:mt,validate:ft},Symbol.toStringTag,{value:"Module"})),yt=`
// READ-ONLY
...
`;function wt(i){return new Function("loadAsync","jszip","jsZipInstance","tf","tfjs","assetURL","applyOneHotEncoding","splitTrainingData",`return (${i.replace(/export/g,"")})`)(E,B,B,c,c,T,z,L)}async function vt(i){let t;try{if(t=await i(E,T,z,L),!t||t.length<4)return p(`
          data did not load
...
`;function kt(i,t,e,n,o,r){return new Function("model","trainingData","validationData","callbacks","numEpochs","tf","tfjs",`return (${i.replace(/export/g,"")})`)(t,e,n,o,r,c,c)}async function Ct(i,t,e,n,o,r){let s;try{if(!t)return p(`
