import{c as Ht,t as ln,a as ct,b as ht,d as hn,e as N,f as Tr,j as Or,l as Pr,g as Ir,J as Fr,A as Mr,h as Nr,s as Rr}from"./utils.03e8e154.js";import{B as K}from"./VideoStreamViewer.fa92fef3.js";const Lr=`<style>\r
  .root {\r
    position: relative;\r
	display: grid;\r
...
`;class kr extends K{static get observedAttributes(){return["style","sign"]}constructor(){super(Lr)}#t=null;#n=null;#e=!0;#o=null;get#r(){return this.#o||(this.#o=this.templateRoot.querySelector(".root")),this.#o}attributeChangedCallback(s,c,h){this.#s(s,h??"")}connectedCallback(){this.#n=this.#r.querySelector(".sign-name"),this.#t=this.#r.querySelector(".sign-image"),this.#s(),this.#e=!1}#s(s=null,c){if(this.#i(s,"sign")){const h=c??this.getAttribute("sign")??"?";this.#n&&(this.#n.innerHTML=h),this.#t&&(this.#t.src=`/asl-client-ml-tutorial/data/signs/${h.toLowerCase()}.jpg`)}}#i(s,c){return this.#e||!c||c===s}}customElements.define("sign-display",kr);const Br=`<style>\r
  .root {\r
    display: flex;\r
...
`;class $r extends K{static get observedAttributes(){return["style","name","step-issues","validating","valid"]}constructor(){super(Br)}#t=null;#n=null;#e=null;#o=null;#r=null;#s=!1;#i=[];#a=!0;#l=null;get#u(){return this.#l||(this.#l=this.templateRoot.querySelector(".root")),this.#l}attributeChangedCallback(s,c,h){s==="step-issues"&&(this.#i=JSON.parse(this.getAttribute("step-issues")||"[]")),this.#c(s,h??"")}connectedCallback(){this.#t=this.#u.querySelector(".name"),this.#n=this.#u.querySelector(".validate-success"),this.#o=this.#u.querySelector(".validate-progress"),this.#e=this.#u.querySelector(".issue-container"),this.#r=this.#u.querySelector(".issue-display"),this.#s=!0,this.#c(),this.#a=!1}disconnectedCallback(){this.#s=!1}#c(s=null,c){if(this.#s){if(this.#d("style",s)&&(this.#u.style.cssText=c??this.getAttribute("style")??""),this.#d("name",s)&&(this.#t.innerHTML=c??this.getAttribute("name")??""),this.#d("validating",s)){const p=this.hasAttribute("validating");this.#o.style.display=p?"":"none"}this.#d("step-issues",s)&&this.#r.setAttribute("issues",JSON.stringify(this.#i));const h=this.#i.length>0;this.#e.style.display=h?"block":"none",this.#n.style.display=this.hasAttribute("valid")?"block":"none"}}#d(s,c){return this.#a||!c||c===s}}customElements.define("step-container",$r);const zr=`<style>
...
<div class="root">\r
  <step-container class="step-container">\r
    ...
    <fluent-tabs activeid="code-tab" class="fluent-tab-container">\r
      ...
      <fluent-tab id="solution-tab">Solution</fluent-tab>\r
      <fluent-tab id="instructions-tab">Instructions</fluent-tab>\r
	...
	<step-container class="step-container">\r
		...
		<div class="contents">\r
			<fluent-tabs activeid="code-tab" class="fluent-tab-container">\r
				...
				<fluent-tab-panel id="codePanel">\r
					<div class="editor-container">\r
						<code-editor allow-background-execution hide-issues class="code-editor">\r
						</code-editor>\r
					</div>\r
				</fluent-tab-panel>\r
				<fluent-tab-panel id="instructionPanel">\r
					<fluent-card>\r
						<div class="description">\r
							...
							<ol>\r
								<li>Use the Mediapipe model to extract the set of joint positions from an image, in this\r
									case,\r
									your\r
									webcam.</li>\r
								<li>Flatten the joint positions into an array of values with the format:\r
									<code>[joint1_x, joint1_y, joint1_z, ..., jointN_x, jointN_y, jointN_z]</code>\r
								</li>\r
		...
		<step-container class="step-container">\r
			...
			<div class="model-import-container">\r
				<div class="localstorage-import">\r
					...
					<div>\r
						<fluent-button class="localstorage-import-button" appearance="accent">Load from "Build"\r
						</fluent-button>\r
					</div>\r
				</div>\r
				<h3>OR</h3>\r
				<div class="zip-file-import">\r
					...
					<div>\r
						<input title="Model file to import" class="model-import-file" type="file"\r
...
</div>`,Fn="import-model-step";class Qt extends K{static get observedAttributes(){return["style"]}constructor(){super(yi)}#t=null;#n=null;#e=null;#o=null;#r=null;#s={..._t};get stepState(){return this.#s}set stepState(s){s!==this.#s&&(this.#s=s,this?.toggleAttribute("valid",s.valid),this.#r?.toggleAttribute("valid",s.valid),this.#r?.setAttribute("step-issues",s.validationIssues?JSON.stringify((s.validationIssues||[]).map(c=>({type:"validation",message:c.detail}))):""),this.#o&&(this.#o.style.display=s.valid?"":"none"),this.#e&&(this.#e.style.display=s.valid?"none":""),this.dispatchEvent(new CustomEvent("stateChanged",{detail:s})))}#i=null;get#a(){return this.#i||(this.#i=this.templateRoot.querySelector(".root")),this.#i}connectedCallback(){this.#r=this.#a.querySelector(".step-container"),this.#e=this.#a.querySelector(".model-import-container"),this.#n=this.#a.querySelector(".localstorage-import-button"),this.#n?.addEventListener("click",()=>void this.#l()),this.#o=this.#a.querySelector(".model-reset-button"),this.#o?.addEventListener("click",()=>{this.stepState={valid:!1,validationIssues:N("No model data selected!").errors,data:null}}),this.#t=this.#a.querySelector(".model-import-file"),this.#t?.addEventListener("change",()=>void this.#u()),this.#u()}async#l(){const s={valid:!1,data:null};try{const c=await Pr(Ir),h=new Fr,y=await c.save(new Mr);Object.keys(y.data).forEach((j,W)=>{W===0?h.file(j,JSON.stringify(y.data[j])):h.file(j,y.data[j])});const A=await h.generateAsync({type:"arraybuffer"});Object.assign(s,await Zt(A))}catch(c){s.valid=!1,s.validationIssues=N(`Could not load model from "Build" step!: ${c}`).errors,console.error(c)}this.stepState=Object.freeze(s)}async#u(){const s={valid:!1,data:null},c=this.#t?.files;if(c&&c.length>0){const h=c[0];try{const p=await h.arrayBuffer();Object.assign(s,await Zt(p))}catch(p){s.valid=!1,s.validationIssues=ht(`Could not load zip file, ${p}`).errors,console.error(p)}this.#t.value=""}else s.valid=!1,s.validationIssues=N("No model data selected!").errors;this.stepState=Object.freeze(s)}}customElements.define(Fn,Qt);const bi=!0,Mn="importModel",wi=Object.freeze(Object.defineProperty({__proto__:null,userMutable:bi,name:Mn,Renderer:Qt,elementName:Fn,ImportModelStep:Qt,validate:Zt,createNoModelSelectedError:Pn,createInvalidModelFileError:In,defaultState:_t,serialize:pi,deserialize:gi},Symbol.toStringTag,{value:"Module"})),Nn=`
/**
...
`;class Rn extends K{#t=null;#n=null;#e=null;#o=null;#r=null;#s=null;#i=null;#a="webcam";#l=null;#u=!1;#c=null;constructor(){super(Si)}#d=null;get#h(){return this.#d||(this.#d=this.templateRoot.querySelector(".root")),this.#d}#f={valid:!1};get stepState(){return this.#f}set stepState(s){s!==this.#f&&(this.#f=s)}#p=null;get pipelineState(){return this.#p}set pipelineState(s){this.#p=s,this.#i=null;const c=s?.steps.importModel?.data;c&&Nr(c).then(h=>{this.#i=h}),this.#v()}async predict(){if(this.#r&&this.#l&&this.#p&&this.#i){const s=this.#t.imageSource,c=s instanceof HTMLVideoElement;if(!c||s.readyState>=2){const h=await this.#l(this.#i,s,c,ct),p=h?`${h.classification} (${(h.confidence*100).toFixed(2)}%)`:"No Prediction";this.#x(p)}}}connectedCallback(){if(this.#t=this.#h.querySelector(".video-stream-viewer"),this.#n=this.#h.querySelector(".start-button"),this.#n.onclick=()=>this.#y(),this.#o=this.#h.querySelector(".predictions-output"),this.#e=this.#h.querySelector(".code-editor"),this.#s=this.#h.querySelector(".sign-display-container"),this.#s){let c="";for(const h of ct)c+=`<sign-display sign="${h}"></sign-display>`;this.#s.innerHTML=c}const s=this.#h.querySelector(".toggle-code-button");if(this.#e){this.#e.addEventListener("change",()=>this.#v()),this.#e.setAttribute("code",Nn);let c=!1;s?.addEventListener("click",()=>{c=!c,this.#e.style.display=c?"":"none"})}super.connectedCallback()}#y(){this.#b()}async#b(){this.#u?await this.#g():await this.#w()}async#w(){await this.#g(),this.#u=!0,this.#n.innerText="Stop",await this.#S(),this.#c=(()=>{let s=!1;const c=async()=>{s||(await this.predict(),setTimeout(c,0))};return setTimeout(c,0),()=>s=!0})()}async#g(){this.#u=!1,this.#n.innerText="Start",await this.#m(),this.#c&&(this.#c(),this.#c=null)}async#S(){if(await this.#m(),this.#a==="webcam"){const s={video:!0,width:200,height:200};this.#r=await navigator.mediaDevices.getUserMedia(s),this.#t.stream=this.#r}}async#m(){this.#r&&(this.#r.getTracks().forEach(s=>s.stop()),this.#t.stream=null,this.#r=null)}#x(s){this.#o.innerText=s??""}#v(){if(this.#l=null,this.#e){const s=this.#e.getAttribute("transpiled-code");s&&(this.#l=At(s,this.pipelineState))}}}customElements.define("run-step",Rn);const ee={valid:!1,validationIssues:[],code:Nn};function xi(d){return JSON.stringify(d)}function ji(d){return d?JSON.parse(d):ee}const Ln="run",Ai=!1,Ci=Object.freeze(Object.defineProperty({__proto__:null,name:Ln,userMutable:Ai,Renderer:Rn,defaultState:ee,serialize:xi,deserialize:ji},Symbol.toStringTag,{value:"Module"})),dt=Object.freeze(Object.defineProperty({__proto__:null,classify:ai,extractAndProcessJointPositions:fi,importModel:wi,run:Ci},Symbol.toStringTag,{value:"Module"}));Rr("predict");const U=document.querySelector(".predict-contents"),un=document.querySelector("step-controller"),ut=U.querySelector(".next-button"),qt=U.querySelector(".reset-button"),Ei=U.querySelector(".predict-container .breadcrumbs"),R=Oi(),_i=kn();async function Ti(){U?.classList.add("initializing"),await Xr();const d=await Ii();let s=Object.freeze({stepNum:1,name:R[0].getAttribute("name")});un?.setAttribute("step",`${s}`),ut?.addEventListener("click",()=>{s.stepNum<R.length&&R[s.stepNum-1].stepState.valid&&h(s.stepNum+1)}),qt?.addEventListener("click",()=>{const p=R[s.stepNum-1],y=p.getAttribute("name");p.stepState=_i.steps[y]});async function c(p,y){d.steps[p]={...y},await Pi(d),s.name===p&&ut?.toggleAttribute("disabled",!d.steps[p].valid);for(const A of R)A.pipelineState=d;dn(R,d)}function h(p){const y=Math.min(p,R.length);s=Object.freeze({stepNum:y,name:R[y-1].getAttribute("name")}),window.location.hash=`#step${s.stepNum}`,un?.setAttribute("step",`${s.stepNum}`);const A=R[s.stepNum-1].getAttribute("name");if(R[s.stepNum-1].stepState=d.steps[A],ut&&(ut.toggleAttribute("disabled",!d.steps[A].valid),ut.style.display=p===R.length?"none":""),qt){const j=dt[s.name].userMutable;qt.style.display=j?"":"none"}dn(R,d)}h(cn()||1),R.forEach(p=>{p.pipelineState=d;const y=p.getAttribute("name");y&&p.addEventListener("stateChanged",()=>void c(y,p.stepState))}),addEventListener("hashchange",()=>h(cn())),U?.classList.add("ready"),U?.classList.remove("initializing")}function cn(){return+((window.location.hash??null).replace("#step","")||"1")}function kn(){return{steps:{importModel:{..._t},extractAndProcessJointPositions:{...Et},classify:{...Ct},run:{...ee}}}}function dn(d,s){for(let c=0;c<d.length;c++){const h=Ei?.querySelector(`[step="${c+1}"]`);if(h){const p=d[c].getAttribute("name"),y=s.steps[p]?.valid??!1;h.classList.toggle("valid",y),h.classList.toggle("invalid",!y)}}}function Oi(){return[U.querySelector(`[name="${Mn}"]`),U.querySelector(`[name="${On}"]`),U.querySelector(`[name="${jn}"]`),U.querySelector(`[name="${Ln}"]`)]}function Pi(d){Object.keys(d.steps).forEach(s=>{if(s in dt&&s in d.steps){const c=dt[s].serialize(d.steps[s]);localStorage.setItem(`predict:${s}`,c??"")}})}function Ii(){const d=kn();return Object.keys(d.steps).forEach(s=>{if(s in dt&&s in d.steps){const c=localStorage.getItem(`predict:${s}`);d.steps[s]=dt[s].deserialize(c)}}),d}Ti();
