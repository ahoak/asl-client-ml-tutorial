...
function createModel(classes: string[]):LayersModel {
  ...
  return model;
}`;function U(i){return new Function("classes","tf","tfjs",`return (${i.replace(/export/g,"")})`)(h,u,u)}async function q(i){let t;try{if(t=await i(h),!t)return f(`"We couldn't find your model. Did you implement createModel function? If so, check that you return your model`)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:m.Unknown,detail:n}]}}return{valid:!0,errors:[],data:[t]}}const X=Object.freeze(Object.defineProperty({__proto__:null,template:N,solution:P,solve:Y,implementation:U,validate:q},Symbol.toStringTag,{value:"Module"}));function M(i){const t=[],e=[],n=h.reduce((a,o,r)=>(a[o]=Array.from({length:h.length}).fill(0),a[o][r]=1,a),{});return Object.keys(i).forEach(a=>{const o=i[a],r=n[a];o.forEach(l=>{t.push(l),e.push(r)})}),{X:t,Y:e}}function C(i,t){const[e,,n]=w(i,t,{testSize:.1,randomState:42}),[a,o,r,l]=w(e,n,{testSize:.1,randomState:42});return[a,o,r,l]}function J(i,t){const e=document.createElement("a");e.setAttribute("href","data:application/zip;base64,"+t),e.setAttribute("download",i),e.style.display="none",document.body.appendChild(e),e.click(),document.body.removeChild(e)}const W=`
// READ-ONLY
...
`;function Q(i,t,e,n){return new Function("model","ArrayBufferModelSaver","download","tf","tfjs","JSZip",`return (${i.replace(/export/g,"")})`)(t,e,n,u,u,L,k)}async function G(i,t){try{await i(t,new k,J)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:m.Unknown,detail:n}]}}return{valid:!0,errors:[]}}const K=Object.freeze(Object.defineProperty({__proto__:null,template:W,solution:Z,implementation:Q,validate:G},Symbol.toStringTag,{value:"Module"})),tt=`
// READ-ONLY
...
`;function nt(i){return new Function("loadAsync","jszip","jsZipInstance","tf","tfjs","assetURL","applyOneHotEncoding","splitTrainingData",`return (${i.replace(/export/g,"")})`)(g,T,T,u,u,b,M,C)}async function at(i){let t;try{if(t=await i(g,b,M,C),!t||t.length<4)return f(`
          data did not load
...
`;function lt(i,t,e,n,a,o,r,l){return new Function("model","xTrainData","yTrainData","xValidationData","yValidationData","callbacks","numEpochs","tf","tfjs",`return (${i.replace(/export/g,"")})`)(t,e,n,a,o,r,l,u,u)}async function dt(i,t,e,n,a,o,r,l){try{const d=await i(t,e,n,a,o,r,l);if(d){if(!d.params)return f(`
