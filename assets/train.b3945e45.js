import{J as x,A as S,k as g,a as f,m as C,n as s,o as j,t as u,e as p,V as w,p as E,q as B,r as T,s as H}from"./utils.fd1d5341.js";import"./WebcamSelector.52eef2b8.js";import P from"https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.6.0/es/highlight.min.js";import q from"https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.6.0/languages/javascript.min.js";const U="ASL Fingerspelling Model Tutorial",J="Train ASL Fingerspelling ML Model using Tensorflowjs",W="ASL Fingerspelling Tutorial \u{1F44B}",Y="",Z="images/ghc_logo_v4.svg",X={github:"https://github.com/ahoak/asl-client-ml-tutorial",twitter:"https://twitter.com/amber_hoak"},Q=!1,G=[{step:1,description:"Load Data",helperText:"Load preprocessed data by pressing the button",name:"loadData",readOnly:"true",imageLink:"instructions/loadData.png"},{step:2,description:"Create and Configure Model",helperText:"creating a feed-forward model. We will use 5 layers with relu activation function. Function must return the model.",name:"createModel",readOnly:"false",imageLink:"instructions/createModel.png"},{step:3,description:"Train Model",helperText:"edit function trainModel() by using the Tf.fit API. Set the following parameters: epochs, batchSize,validationData, callbacks. Hint, you may need to transform your data into tensors ",name:"trainModel",readOnly:"false",imageLink:"instructions/trainModel.png"},{step:4,description:"Download Model Files",helperText:"Click the button to download your shiney new model. We will use this in our webapp.",name:"exportModel",readOnly:"true",imageLink:"instructions/exportModel.png"}],K=[{step:1,description:"Import Model",helperText:"Import a pre-trained model to perform inference with."},{step:2,description:"Extract and Process Joint Positions",helperText:"Extract the hand joint positions from within an image."},{step:3,description:"Classify",helperText:"Run inference with the normalized joint positions to get a classification (ASL sign)."},{step:4,description:"Run",helperText:"Run prediction on the model"}],tt={metaTitle:U,metaDescription:J,name:W,theme:Y,avatarImage:Z,social:X,showDataVideo:Q,trainTutorialSteps:G,predictSteps:K};function z(o){const t=[],e=[],n=f.reduce((i,r,a)=>(i[r]=Array.from({length:f.length}).fill(0),i[r][a]=1,i),{});return Object.keys(o).forEach(i=>{const r=o[i],a=n[i];r.forEach(d=>{t.push(d),e.push(a)})}),{inputs:t,outputs:e}}function L(o,t){const[e,,n]=C(o,t,{testSize:.1,randomState:42}),[i,r,a,d]=C(e,n,{testSize:.1,randomState:42});return[i,r,a,d]}function A(o,t){const e=document.createElement("a");e.setAttribute("href","data:application/zip;base64,"+t),e.setAttribute("download",o),e.style.display="none",document.body.appendChild(e),e.click(),document.body.removeChild(e)}async function et(o){await o.save("localstorage://model"),console.log("model saved to localstorage!");const t=new x,n=await o.save(new S);Object.keys(n.data).forEach((i,r)=>{r===0?t.file(i,JSON.stringify(n.data[i])):t.file(i,n.data[i])}),await t.generateAsync({type:"base64"}).then(function(i){A("model.zip",i)},function(i){console.warn(i)})}async function nt(o,t,e,n,i=5,r=128){if(!o||!t||!e)return new Error("missing parameter for trainModel");const a=g(t.inputs),d=g(t.outputs),c=g(e.inputs),l=g(e.outputs),h=await o.fit(a,d,{epochs:i,batchSize:r,verbose:1,validationData:[c,l],callbacks:n});return a.dispose(),d.dispose(),c.dispose(),l.dispose(),h}const it=".loading-element",_=".train-button",R="#validation-status";function m(o,t,e){const n=s(R);n.innerHTML=e;const i=s(it);if(i.style.visibility="hidden",k(o,t),t){const r=s(_);r.disabled=!1}}function ot(o){k(o,null),V()}function V(){const o=s(R);o.innerHTML="";const t=s(_);t.disabled=!0}const st=new Map([["loadData","\u2714\uFE0F Data loaded \u{1F4BE}"],["createModel","\u2714\uFE0F Yay! Model created! \u{1F389}"],["trainModel","\u2714\uFE0F Training complete!\u{1F45F}"],["exportModel",'\u2714\uFE0F Downloaded! Time to make some <a href="/predict#step1">predictions</a> \u{1F57A}']]);function y(o){return st.get(o)??""}function k(o,t){const e=s(`#tutorial-step${o}`);e?.classList.toggle("valid",t!=null&&t),e?.classList.toggle("invalid",t!=null&&!t)}const D=5;class at{#n=D;#o=128;#i=1;#t=0;#s;#l=!0;#a=s(".training-feedback-container");#d=s(".training-progress-bar");#u=s(".training-start-button");#e=s(".training-stop-button");#r={};#c;#p;constructor(t){this.#n=t?.epochs??D}set aslModel(t){this.#p=t}get aslModel(){return this.#p}set currentStep(t){this.#s=t}get currentStep(){return this.#s}get step(){return this.#s?.step}get stepName(){return this.#s?.name}get epochs(){return this.#n}completedValidation(t,e){this.#r[t]=e}getCompletedState(t){return this.#r[t]??!1}handleReset(t){t==="createModel"&&(this.#p=void 0),this.completedValidation(t,!1)}getTrainingData(){if(this.#c){const[t,,e]=this.#c;return{inputs:t,outputs:e}}}getValidationData(){if(this.#c){const[,t,,e]=this.#c;return{inputs:t,outputs:e}}}handleModelResults=t=>{t.valid&&t.data&&t.data.length>0&&(this.#p=t.data[0])};handleModelCreation=t=>{t.valid&&t.data&&t.data.length>0?this.#p=t.data[0]:console.log("no data provided to ModelBuilder, please retry load data function")};handleDataSplitValidation=t=>{t.valid&&t.data&&t.data.length>0?this.#c=t.data[0]:console.log("no data provided to ModelBuilder, please retry load data function")};handleTrainValidation=t=>{if(t.valid&&t.data&&t.data.length>0){const[e,n]=t.data;this.#o=e,this.#n=n}else console.log("no data provided to ModelBuilder, please retry load data function")};onBatchEnd=(t,e)=>{this.#a.style.display="inline-block",!this.#l&&this.#p&&(this.#p.stopTraining=!0),this.#a.innerHTML=`
      ...
      <br>
      `};async onDownload(){const t=this.#p;t?(await et(t),m(this.step??1,!0,y("exportModel"))):m(this.step??1,!1,"no model loaded")}onEpochEnd=t=>{const e=Date.now()-this.#t;this.#i=t+2;const n=this.#n-t,i=e*n,[r,a]=j(i);this.#d.innerHTML=`${r} ${a?"minutes":"seconds"} remaining`,this.#t=Date.now(),t===this.#n-1&&m(this.step??1,!0,y("trainModel"))};getCallbacks(){return{onBatchEnd:this.onBatchEnd,onEpochEnd:this.onEpochEnd}}handleValidationComplete=(t,e,n)=>{if(this.#s?.step===e){const i=n?y(t):"validation failed";n&&t==="trainModel"?this.enableTrainingButtons():this.disableTrainingButtons(),t==="trainModel"?k(e,n):t!=="exportModel"&&m(e,n,i)}};disableTrainingButtons(){this.#u.disabled=!0,this.#e.disabled=!0}enableTrainingButtons(){this.#u.disabled=!1,this.#e.disabled=!1}handleTrainingStopped(){this.#l=!1,this.#u.disabled=!1,m(this.step??1,!0,y("trainModel"))}getTrainingInputs(){return[this.#p,this.getTrainingData(),this.getValidationData(),this.getCallbacks(),this.#n]}async onTrainingClick(){const[t,e,n,i,r]=this.getTrainingInputs();t&&(t.stopTraining=!1,this.#l=!0,this.#i=1,this.#u.disabled=!0,await nt(t,e,n,i,r,this.#o))}set trainingEnabled(t){this.#l=t}}const rt=`
...
function createModel(classes: string[]):LayersModel {
  ...
  return model;
}`;function ut(o){return new Function("classes","tf","tfjs",`return (${o.replace(/export/g,"")})`)(f,u,u)}async function ct(o){let t;try{if(t=await o(f),!t)return p(`"We couldn't find your model. Did you implement createModel function? If so, check that you return your model`)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:w.Unknown,detail:n}]}}return{valid:!0,errors:[],data:[t]}}const pt=Object.freeze(Object.defineProperty({__proto__:null,template:rt,solution:lt,solve:dt,implementation:ut,validate:ct},Symbol.toStringTag,{value:"Module"})),ht=`
// READ-ONLY
...
`;function ft(o,t,e,n){return new Function("model","ArrayBufferModelSaver","download","tf","tfjs","JSZip",`return (${o.replace(/export/g,"")})`)(t,e,n,u,u,x,S)}async function gt(o,t){try{await o(t,new S,A)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:w.Unknown,detail:n}]}}return{valid:!0,errors:[]}}const yt=Object.freeze(Object.defineProperty({__proto__:null,template:ht,solution:mt,implementation:ft,validate:gt},Symbol.toStringTag,{value:"Module"})),bt=`
// READ-ONLY
...
`;function vt(o){return new Function("loadAsync","jszip","jsZipInstance","tf","tfjs","assetURL","applyOneHotEncoding","splitTrainingData",`return (${o.replace(/export/g,"")})`)(E,B,B,u,u,T,z,L)}async function St(o){let t;try{if(t=await o(E,T,z,L),!t||t.length<4)return p(`
          data did not load
      `)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:w.Unknown,detail:n}]}}return{valid:!0,errors:[],data:[t]}}const Et=Object.freeze(Object.defineProperty({__proto__:null,template:bt,solution:wt,implementation:vt,validate:St},Symbol.toStringTag,{value:"Module"})),Tt=`
...
`;function Ct(o,t,e,n,i,r){return new Function("model","trainingData","validationData","callbacks","numEpochs","tf","tfjs",`return (${o.replace(/export/g,"")})`)(t,e,n,i,r,u,u)}async function Bt(o,t,e,n,i,r){let a;try{if(!t)return p(`
      ...
      `)}catch(l){const h=`${JSON.stringify(l)}`;return{valid:!1,errors:[{type:w.Unknown,detail:h}]}}const d=a?a.params?.batchSize:128,c=a?a.params?.epochs:5;return{valid:!0,errors:[],data:[d,c]}}const Dt=Object.freeze(Object.defineProperty({__proto__:null,template:Tt,solution:kt,solve:Mt,implementation:Ct,validate:Bt},Symbol.toStringTag,{value:"Module"})),v={createModel:pt,exportModel:yt,trainModel:Dt,loadData:Et};class It{#n=s(".training-feedback-container");#o=s("#solution-tab");#i=s(".train-button");#t=s(".reset-button");#s=s(".training-stop-button");#l=s(".training-start-button");#a=s(".download-button");#d=s(".solve-button");showTrainingButtons(){this.#l.style.display="inline-flex",this.#s.style.display="inline-flex"}hideTrainingButtons(){this.#s.style.display="none",this.#l.style.display="none",this.#n.style.display="none"}showTrainingOutput(){this.#n.style.display="inline-block"}hideTrainingOutput(){this.#n.style.display="none"}showDownload(){this.#a.style.display="inline-flex"}hideDownload(){this.#a.style.display="none"}hideCodeButtons(){this.#t.style.display="none",this.#d.style.display="none",this.#o.style.display="none"}showCodeButtons(){this.#t.style.display="inline-flex",this.#d.style.display="inline-flex",this.#o.style.display="inline-flex"}hideNextButton(){this.#i.style.display="none"}showNextButton(){this.#i.style.display="inline-flex"}showInstructions(t){const e=s(`#${t}-image`);e.style.display="block"}hideInstructions(t){const e=s(`#${t}-image`);e.style.display="none"}}function xt(o){const t=document.querySelector(`#tutorial-step${o}`);t&&(t.style.fontWeight="bold")}function zt(o){const t=document.querySelector(`#tutorial-step${o}`);t&&(t.style.fontWeight="revert")}let Lt=()=>({events:{},emit(o,...t){let e=this.events[o]||[];for(let n=0,i=e.length;n<i;n++)e[n](...t)},on(o,t){return this.events[o]?.push(t)||(this.events[o]=[t]),()=>{this.events[o]=this.events[o]?.filter(e=>t!==e)}}});const b="validated",At="validationInProgress",I="validationComplete";class _t{#n=0;#o;#i;#t;#s=!1;#l=[];#a;#d;#u;#e;constructor(t){this.#n=t.stepCount??0,this.#o=t.stepRecord,this.#i=t.element,this.#t=t.name,this.#d=localStorage.getItem(`build-ts:${this.#t}`),this.#u=t.solutionElement,this.#a=Lt(),this.setEventListener()}set show(t){t?(this.#i.setAttribute("style","display: flex;width: 100%;height:calc(100vw / 2)"),this.showSolution(!0)):(this.#i.setAttribute("style","display:none;"),this.showSolution(!1))}showSolution(t){this.#u&&(t?this.#u.setAttribute("style","display: flex;width: 100%;height:calc(100vw / 2)"):this.#u.setAttribute("style","display:none;"))}set code(t){this.#i.setAttribute("code",t)}set allowBackgroundExecution(t){this.#i.toggleAttribute("allow-background-execution",t)}set readonly(t){this.#i.toggleAttribute("readonly",t)}get solutionElement(){return this.#u}get stepCount(){return this.#n}resetCodeToDefault(){this.code=this.#o.template,localStorage.removeItem(`build:${this.#t}`),localStorage.removeItem(`build-ts:${this.#t}`),this.#d=null,this.#s=!1}solve(){this.code=this.#o.solve??this.#o.solution}on(t,e){return this.#a.on(t,e)}set overrideEventListener(t){this.#e=t}setEventListener(){this.#i.addEventListener("change",async t=>{const e=t,n=!e.detail.hasSyntaxErrors,i=e.detail.transpiledCode;n?(localStorage.setItem(`build-ts:${this.#t}`,e.detail.transpiledCode),localStorage.setItem(`build:${this.#t}`,e.detail.code),this.#d=e.detail.transpiledCode,this.#e||await this.handleEvalInput(i)):this.#a.emit(I,this.#t,this.#n,!1)})}set funcInput(t){this.#l=t}setCodeFromCacheOrDefault(){const t=localStorage.getItem(`build:${this.#t}`),e=t&&t.length>0?t:this.#o.template;this.code=e}async runCachedCode(){try{this.#d&&await this.handleEvalInput(this.#d)}catch(t){console.warn(t)}}async handleEvalInput(t){this.#a.emit(At,this.#t,this.#n);const e=t??this.#i.getAttribute("code")??"",n=this.#o.implementation(e,...this.#l);if(this.#o.validate)try{const i=await this.#o.validate(n,...this.#l);this.#i.setAttribute("validation-issues",JSON.stringify(i.valid?[]:i.errors)),this.#s=i.valid,this.#s&&this.#a.emit(b,i)}catch(i){console.log(i)}this.#a.emit(I,this.#t,this.#n,this.#s)}get isValid(){return this.#s}}const Rt=tt;class Vt{#n=!1;#o=s("#output-element");#i=document.querySelectorAll("code-step");#t=s(".train-button");#s=s(".reset-button");#l=s(".training-stop-button");#a=s(".training-start-button");#d=s(".download-button");#u=s(".solve-button");#e=new at;#r=new It;#c={};init(){this.#t.disabled=!0,this.#t.onclick=this.handleNextButtonClick,this.#s.onclick=this.handleResetButtonClick,this.#l.onclick=this.handleStopTrainingClick,this.#a.onclick=this.handlestartTrainingClick,this.#d.onclick=this.handleDownloadClick,this.#u.onclick=this.handleSolveClick,this.mapCodeSteps()}mapCodeSteps(){const t=Object.keys(v).reduce((e,n)=>(e[n]={valid:!1,...v[n]},e),{});this.initCodeSteps(t)}initCodeSteps(t){const e={};this.#i.forEach(n=>{const i=n.getAttribute("name")??"";if(/-solution/.test(i)){const a=i.replace("-solution","");e[a]=n}}),this.#i.forEach(n=>{const i=n.getAttribute("name")??"",r=n.getAttribute("step")??"",a=v[i];if(i&&a){const d=t[i];let c;e[i]&&(c=e[i],c.setAttribute("code",d.solution),c.toggleAttribute("readonly",!0));const l=new _t({stepRecord:d,element:n,name:i,stepCount:+r,solutionElement:c});switch(this.#c[i]=l,i){case"loadData":l.funcInput=[E,T],l.on(b,this.#e.handleDataSplitValidation);break;case"createModel":l.funcInput=[u,f],l.on(b,this.#e.handleModelCreation);break;case"trainModel":l.on(b,this.#e.handleTrainValidation);break}l.setCodeFromCacheOrDefault(),l.on("validationComplete",this.#e.handleValidationComplete)}})}handleResetButtonClick=()=>{const t=this.#e.currentStep?.name??"",e=this.#c[t];e.resetCodeToDefault(),this.#r.hideTrainingOutput(),this.#t.disabled=!0,ot(e.stepCount)};handleSolveClick=()=>{const t=this.#e.currentStep?.name??"",e=this.#c[t];e&&e.solve()};handleStopTrainingClick=()=>{this.#e.handleTrainingStopped(),this.#t.disabled=!1};handleNextButtonClick=async()=>{const e=(this.#e.step??1)+1;window.location.hash=`#step${e}`,await this.onStepChange(e)};async onStepChange(t){const e=this.#e.stepName;if(e){this.#n&&this.toggleSolution(!1,e),this.#r.hideInstructions(e);const n=this.#c[e];zt(n.stepCount),n.show=!1}V(),await this.setCurrentStep(t)}handleSolutionButtonClick=()=>{const t=!this.#n,e=this.#e.stepName??"";this.toggleSolution(t,e)};toggleSolution(t,e){this.#n=t,this.#c[e].showSolution(t)}handlestartTrainingClick=async()=>{this.#t.disabled=!0,await this.#e.onTrainingClick()};handleDownloadClick=async()=>{await this.#e.onDownload()};async handleStepChange(t,e="false"){const n=this.#c[t];n?(this.#r.showInstructions(t),e&&(n.readonly=e==="true"),t==="trainModel"?(n.funcInput=this.#e.getTrainingInputs(),this.#r.showTrainingButtons(),this.#e.disableTrainingButtons()):this.#r.hideTrainingButtons(),e==="true"?this.#r.hideCodeButtons():this.#r.showCodeButtons(),t==="exportModel"?(n.funcInput=[this.#e.aslModel,u],this.#r.showDownload(),this.#r.hideNextButton(),n.overrideEventListener=!0):(this.#r.hideDownload(),this.#r.showNextButton(),await n.runCachedCode()),n.show=!0):console.error(`Instance of StepViewer for ${t} is not found`)}async setCurrentStep(t){const e=Rt.trainTutorialSteps.find(n=>n.step===t);if(e!=null){this.#e.currentStep=e;const n=e.step;xt(n),this.#o.innerHTML=`${n}. ${e.description} `,await this.handleStepChange(e.name,e.readOnly)}}}H("build");const M=new Vt;M.init();function $(){return+((window.location.hash??null).replace("#step","")||"1")}window.addEventListener("hashchange",()=>M.onStepChange($()));M.onStepChange($());P.registerLanguage("javascript",q);
