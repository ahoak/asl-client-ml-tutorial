...
function createModel(classes: string[]):LayersModel {
  ...
  return model;
}`;function lt(o){return new Function("classes","tf","tfjs",`return (${o.replace(/export/g,"")})`)(f,u,u)}async function dt(o){let t;try{if(t=await o(f),!t)return p(`"We couldn't find your model. Did you implement createModel function? If so, check that you return your model`)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:w.Unknown,detail:n}]}}return{valid:!0,errors:[],data:[t]}}const ut=Object.freeze(Object.defineProperty({__proto__:null,template:st,solution:at,solve:rt,implementation:lt,validate:dt},Symbol.toStringTag,{value:"Module"})),ct=`
// READ-ONLY
...
`;function ht(o,t,e,n){return new Function("model","ArrayBufferModelSaver","download","tf","tfjs","JSZip",`return (${o.replace(/export/g,"")})`)(t,e,n,u,u,x,S)}async function mt(o,t){try{await o(t,new S,A)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:w.Unknown,detail:n}]}}return{valid:!0,errors:[]}}const ft=Object.freeze(Object.defineProperty({__proto__:null,template:ct,solution:pt,implementation:ht,validate:mt},Symbol.toStringTag,{value:"Module"})),gt=`
// READ-ONLY
...
`;function bt(o){return new Function("loadAsync","jszip","jsZipInstance","tf","tfjs","assetURL","applyOneHotEncoding","splitTrainingData",`return (${o.replace(/export/g,"")})`)(E,B,B,u,u,T,z,L)}async function wt(o){let t;try{if(t=await o(E,T,z,L),!t||t.length<4)return p(`
          data did not load
      `)}catch(e){const n=`${e}`;return{valid:!1,errors:[{type:w.Unknown,detail:n}]}}return{valid:!0,errors:[],data:[t]}}const vt=Object.freeze(Object.defineProperty({__proto__:null,template:gt,solution:yt,implementation:bt,validate:wt},Symbol.toStringTag,{value:"Module"})),St=`
...
`;function kt(o,t,e,n,i,r){return new Function("model","trainingData","validationData","callbacks","numEpochs","tf","tfjs",`return (${o.replace(/export/g,"")})`)(t,e,n,i,r,u,u)}async function Mt(o,t,e,n,i,r){let a;try{if(!t)return p(`
